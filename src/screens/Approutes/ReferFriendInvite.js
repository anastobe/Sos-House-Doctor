 ...
 const InputFields = () =>{
    return (
        <View style={{ marginHorizontal: 15 , marginVertical:  SIZES.padding }} >
          ...
          <View style={{ borderColor: COLORS.white, borderWidth: 1, borderRadius: 4, backgroundColor: "#fff", ...SHADOWELEV_2, height: 42, flexDirection: "row", justifyContent: "space-between",  }}>
            <TextInput 
            value={email} 
            onChangeText={setemail} 
            placeholder={"Enter your email"}  
            />
             <TouchableOpacity style={{ marginRight: 15, justifyContent: "center" }}  onPress={ ()=> console.log("add button pressed") } >
       
          <View style={{  height: 22, width: 30 ,justifyContent: "center", alignItems: "center", backgroundColor: COLORS.btnColor2, borderRadius: 5 }} >
             <Icon name={IONICONS.add} color={"#fff"} size={18} />
          </View>
...
const InviteFriendsBtn = () =>{
 ...
 const Ortxt = () =>{
  return(
    ...
    ></View>
      <Text style={{ alignSelf: "center", ...FONTS.p5, color: COLORS.black, marginVertical: 10 }} >OR</Text>
