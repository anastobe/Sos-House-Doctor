...
const SuccessfullReferPatient = ({ ...props }) => {

  const card = () =>{
    return(
      <View style={{ height: 190 ,backgroundColor: COLORS.mainColor, marginHorizontal: 15, borderRadius: 10, justifyContent: "center", alignItems: "center" }} >
...
export default SuccessfullReferPatient
