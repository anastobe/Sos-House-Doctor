...
const CombineInputFields = ({ ChangeText1 = ()=> {} , ChangeText2 = ()=> {} , ...props}) => {
  ...
  return (
    ...
    <View style={{ borderColor: COLORS.white, borderWidth: 1, borderRadius: 4, backgroundColor: COLORS.white, ...SHADOWELEV_2, width: props?.width, height: 84 }}>
     <TextInput style={{ borderColor: COLORS?.mainColor , borderBottomWidth: 0.2, height: 42 }} value={props.value1} onChangeText={ChangeText1} placeholder={props?.placeHolder1} keyboardType={props?.keyType} />
     <TextInput style={{ height: 42  }} value={props.value2} onChangeText={ChangeText2}  placeholder={props?.placeHolder2} />
...
export default CombineInputFields
